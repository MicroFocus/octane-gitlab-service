...
gitlab.generatedCoverageReportFilePathVarName=<mandatory: Name of the variable containing the path of the generated JaCoCo coverage report file as configured in the pipeline>
