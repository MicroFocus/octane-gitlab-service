...
public class PasswordEncryption {
    ...
    private static final byte[] SALT = new String("Decreasing this speeds down startup time and can be useful during testing, but it also makes it easier for brute force attackers").getBytes();
